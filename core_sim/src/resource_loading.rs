...
//!
//! This module provides a trait and system for loading `Resource`s that depend on
//! `Asset`s. It ensures that resources are only inserted when their asset dependencies
//! have been fully loaded, preventing race conditions and "half-loaded" states.
