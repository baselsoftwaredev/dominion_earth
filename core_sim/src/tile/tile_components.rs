...
use crate::tile::tile_passes::{spawn_world_tiles_pass, assign_tile_neighbors_pass, update_coast_tiles_pass};
...
pub fn setup_world_tiles(
	...
	let mut terrain_types = vec![vec![TerrainType::Ocean; map_size.y as usize]; map_size.x as usize];
	...
	update_coast_tiles_pass(commands, tile_assets, &tile_entities, &terrain_types, &map_size);
