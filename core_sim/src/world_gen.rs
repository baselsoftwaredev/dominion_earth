...
/// Scaled for 50x25 map (reduced from original 100x50 map)
pub fn get_starting_positions() -> Vec<(String, Position, [f32; 3])> {
    vec![
        ("Egypt".to_string(), Position::new(26, 12), [1.0, 0.8, 0.0]),
        (
            "Babylon".to_string(),
            Position::new(27, 11),
            [0.6, 0.4, 0.8],
        ),
        ("Greece".to_string(), Position::new(25, 10), [0.0, 0.5, 1.0]),
        ("Rome".to_string(), Position::new(24, 9), [0.8, 0.2, 0.2]),
        ("Persia".to_string(), Position::new(29, 11), [0.5, 0.0, 0.5]),
        ...
        ("Aztecs".to_string(), Position::new(10, 12), [0.8, 0.8, 0.0]),
        ("Incas".to_string(), Position::new(12, 17), [0.5, 0.8, 0.3]),
        ("Maya".to_string(), Position::new(9, 13), [0.0, 0.8, 0.0]),
        (
            "Iroquois".to_string(),
            Position::new(15, 9),
            [0.4, 0.2, 0.0],
        ),
        ("Mali".to_string(), Position::new(22, 15), [0.8, 0.5, 0.0]),
        (
            "Ethiopia".to_string(),
            Position::new(27, 16),
            [0.6, 0.8, 0.2],
        ),
        ("Zulu".to_string(), Position::new(26, 21), [0.2, 0.0, 0.0]),
        ("Arabs".to_string(), Position::new(28, 13), [0.0, 0.6, 0.0]),
        (
            "Ottomans".to_string(),
            Position::new(26, 10),
            [0.8, 0.0, 0.0],
        ),
        ("Korea".to_string(), Position::new(40, 9), [0.8, 0.8, 0.8]),
        ("Siam".to_string(), Position::new(36, 14), [1.0, 0.0, 0.5]),
        ("Khmer".to_string(), Position::new(36, 14), [0.5, 0.0, 0.5]),
        (
            "Indonesia".to_string(),
            Position::new(38, 16),
            [0.0, 0.5, 0.0],
        ...
        ("Spain".to_string(), Position::new(22, 10), [0.8, 0.8, 0.0]),
        (
            "Netherlands".to_string(),
            Position::new(23, 7),
            [1.0, 0.5, 0.0],
        ),
        ("Poland".to_string(), Position::new(25, 7), [1.0, 1.0, 1.0]),
        ("Sweden".to_string(), Position::new(24, 5), [0.0, 0.3, 0.8]),
        ("Brazil".to_string(), Position::new(14, 19), [0.0, 1.0, 0.0]),
        (
            "Argentina".to_string(),
            Position::new(13, 22),
            [0.5, 0.8, 1.0],
        ),
        ("Canada".to_string(), Position::new(14, 5), [1.0, 0.0, 0.0]),
        (
            "America".to_string(),
            Position::new(12, 10),
            [0.0, 0.0, 1.0],
        ),
        ("Mexico".to_string(), Position::new(11, 12), [0.0, 0.5, 0.3]),
        (
            "Morocco".to_string(),
            Position::new(22, 12),
            [0.8, 0.0, 0.0],
